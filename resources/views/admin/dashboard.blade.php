                    ...
                    <table class="table table-hover table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @if($prod->image)
                                        <img src="{{ asset('storage/products/' . $prod->image) }}" alt="{{ $prod->productname }}" width="45" height="45" class="object-fit-cover rounded" onerror="this.onerror=null;this.src='{{ asset('images/default.png') }}';">
                                    @else
