                                    ...
                                    @foreach ($cart as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="number" min="1" class="form-control form-control-sm text-center mx-auto input-update-cart" 
                                                       style="width: 75px;" value="{{ $item['quantity'] }}" 
                                                       data-url="{{ route('cart.update', $item['productid']) }}">
                                            </td>
                                            <td class="text-end text-danger fw-bold subtotal">{{ number_format($subtotal) }} đ</td>
                                            <td class="text-center">
